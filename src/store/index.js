        ...
        [
          ...
          },
          {
            ...
            "tr_content":[
              ...
              {
                "para": "صبح که از خواب پا شدم، بازم آبله رو پام دیدم. خیلی رنج‌آور بود، و آخر کاری هم این دست و اون دست کردم، در عین حال که داشتم می‌رفتم سمت قفس سَگا. اونا از صبحه که ساکتِ ساکت‌ان، که خب این خیلی غیرعادی‌ـه، و فهمیدم که یه سری‌هاشون فرار کردن.",
                "dir": "right"
              },
              {
          ...
          },
          {
            ...
            "tr_content":[
              ...
              {
                "para": "در ثانی، سیستم امنیتی‌مان همچنان فعال است، اما جوخه‌ی نگهبانی امنیتی ویژه، تقریبا از بین رفته. از این رو، اطلاعات تحقیقاتی‌ای که توسط کمپانی ما فوق سری به شمار می‌رفت، برای غیرخودی‌ها نیز در دسترس قرار گرفته. به زودیِ هر چه تمام باید اقدامات متقابلی صورت بگیرد.",
                "dir": "right"
              },
              {
