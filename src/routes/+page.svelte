...
<main class="pt-12 text-white xl:pt-14">
	<article class="flex flex-col mx-auto max-w-[40rem] w-full xl:p-4 p-3 xl:leading-10 leading-8 xl:gap-7 gap-6">
		...
		<img class="w-2/5 mx-auto max-w-64" src={logo} alt="Logo">
		...
		<details class="py-2 border-gray-700 xl:border-y-2 border-y">
